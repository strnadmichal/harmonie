...
//  EDITOVATELNÉ CENY
// ============================================================
// Zde upravujte pouze číselné hodnoty cen.
// Texty jako "Kč osoba/noc" se doplní automaticky níže.
// Pro položky "zdarma" je zde hodnota 0, ale v tabulce se použije text "zdarma".
const priceValues = {
  adults_winter: 610,
  adults_summer: 590,
  adults_special: 690,
  children_12_winter: 410,
  children_12_summer: 390,
  children_12_special: 450,
  children_2: 0, // Pro děti do 2 let (použije se text "zdarma")
  extra_bed_winter: 250,
  extra_bed_summer: 250,
  extra_bed_special: 400,
  adults_1night: 760,
  single_room_winter: 800,
  single_room_summer: 800,
  single_room_special: 1000,
  apartment_surcharge: 150,
  breakfast_adults: 160,
  breakfast_children: 80,
  sauna: 400
};
// ============================================================
//  KONEC EDITOVATELNÝCH CEN
// ============================================================
...
cs: {
  ...
  prices: {
    ...
    table: {
      ...
      single_room_winter: `${priceValues.single_room_winter} Kč osoba/noc`,
      single_room_summer: `${priceValues.single_room_summer} Kč osoba/noc`,
      single_room_special: `${priceValues.single_room_special} Kč osoba/noc`,
      apartment_surcharge: "Příplatek za apartmán",
      apartment_surcharge_price: `${priceValues.apartment_surcharge} Kč osoba/noc`,
  ...
  privacy: {
    ...
    whatDataIntro: "Prostřednictvím našeho formuláře pro nezávaznou rezervaci shromažďujeme následující osobní údaje:",
    dataName: "Jméno a příjmení",
    dataEmail: "E-mailová adresa",
    dataPhone: "Telefonní číslo",
    whyDataTitle: "Proč tyto údaje shromažďujeme?",
    whyDataText: "Údaje shromažďujeme výhradně za účelem zpracování vaší nezávazné rezervace a případné komunikace s vámi. Právním základem pro zpracování osobních údajů je čl. 6 odst. 1 písm. b) GDPR – plnění smlouvy nebo předsmluvních opatření.",
    howLongTitle: "Jak dlouho údaje uchováváme?",
    howLongText: "Vaše údaje uchováváme po dobu nezbytnou k vyřízení rezervace, maximálně však 6 měsíců. Poté budou bezpečně smazány.",
    whoShareTitle: "Komu údaje poskytujeme?",
    whoShareText: "Vaše osobní údaje nejsou poskytovány žádné třetí straně.",
    securityTitle: "Jak údaje chráníme?",
    securityText: "Osobní údaje jsou uchovávány v zabezpečeném systému a nejsou zpřístupněny neoprávněným osobám.",
    ...
    rightsContact: "Kontaktujte nás našem e-mailu a vaši žádost vyřídíme.",
    complaintTitle: "Možnost podání stížnosti",
    complaintText: "Pokud se domníváte, že bylo s vašimi osobními údaji nakládáno v rozporu s právními předpisy, máte právo podat stížnost u Úřadu pro ochranu osobních údajů (www.uoou.cz).",
    contactTitle: "Kontakt",
    contactText: "Pokud máte jakékoli dotazy ohledně zpracování vašich osobních údajů, neváhejte nás kontaktovat na našem emailu harmonie-bedrichov@centrum.cz"
  }
},
en: {
  nav: {
  ...
  home: {
    ...
    description: "Our family pension with the unique atmosphere of an original Jizera Mountains cottage offers cozy and comfortable rooms and apartments, a common room with a fireplace, bar, kitchen, children's playroom, ski storage, sauna, and much more for your relaxing holiday, weekend in nature, or meeting with friends and family."
  },
  accommodation: {
    title: "Accommodation",
    rooms: "Rooms",
  ...
  services: {
    ...
    sauna: {
      title: "Sauna",
      description: "For sauna enthusiasts, we recently built a beautiful small sauna with stone cladding, vaulted ceiling, creative lighting, and a wooden cooling tub. During proper sauna use, muscle tension is released, airways are cleared, your immunity is strengthened, and your body undergoes overall detoxification."
    },
    parking: {
      title: "Parking",
  ...
  prices: {
    ...
    table: {
      ...
      single_room_winter: `${priceValues.single_room_winter} CZK per person/night`,
      single_room_summer: `${priceValues.single_room_summer} CZK per person/night`,
      single_room_special: `${priceValues.single_room_special} CZK per person/night`,
      apartment_surcharge: "Apartment Surcharge",
      apartment_surcharge_price: `${priceValues.apartment_surcharge} CZK per person/night`,
    ...
    included: {
      ...
      description: "WiFi throughout the property, energy, water, garbage collection, final cleaning, towels, bedding, TV/SAT, bike and ski storage, parking, use of the premises.",
    },
      notIncluded:{
      title: "Prices do not include:",
      description: "Municipal tourist tax - the fee rate is 35 CZK per person over 18 years old per day of stay.",
    },
      paymentTerms: {
      title: "Reservation and Payment Terms:",
      description: "The accommodation reservation is valid after paying a deposit of 20% of the total accommodation price. The balance is paid in cash or by bank transfer on the day of arrival."
    },
    cancellation: {
  ...
  operating_rules: {
    ...
    rule1: "1. Only guests who are registered for accommodation may be accommodated in the guesthouse upon presentation of an ID card, valid passport or other proof of identity.",
    rule2: "2. Persons who are not affected by infectious diseases are allowed to use the hotel facilities.",
    rule3: "3. If a guest requests an extension of his/her stay, he/she may be offered a room other than the one in which he/she was originally accommodated.",
    rule4: "4. The guest shall use the room for the period of time agreed upon upon arrival. Unless otherwise agreed, rooms are ready from 15:00, on the last day of the stay the guest vacates the room by 10:00 at the latest. If the guest house operation allows, it is possible to arrange a later time for the room release.",
    rule5: "5. The guest is obliged to observe the night quiet from 10:00 pm to 7:00 am",
    rule6: "6. The guest is obliged to pay for the stay and services provided in accordance with the current price list, usually upon arrival.",
    rule7: "7. The guest is not allowed to bring and consume their own drinks and food in the restaurant.",
    rule8: "8. In the room and common areas, the guest is not allowed to move equipment, make repairs or any interference with the electrical network or other installations without the owner's consent.",
    rule9: "9. It is not allowed to use own electrical appliances (e.g. kettles, cookers, toasters, etc.) Exceptions are shavers and massagers, hair dryers, curling irons, radios. The guest is responsible for the use of permitted appliances and is liable for any damage caused by their operation.",
    rule10: "10. When leaving the room, the guest is obliged to close the water taps, turn off the lights, turn off the TV, close the windows and hand over the key at the end of the stay.",
    rule11: "11. It is not allowed to bring sports equipment and items (skis, sledges, bicycles) to the rooms, for which another place is reserved.",
    rule12: "12. For safety reasons it is not allowed to leave children without adult supervision in the room and other areas of the pension. Parents are responsible for the safety of their children in all areas of the guesthouse and its outdoor areas.",
    rule13: "13. The guest is fully responsible for any damage caused to the property of the guesthouse.",
    rule14: "14. Small pets can be placed in the premises of the guesthouse only with the consent of the owner.The owner of the pet is obliged to prove its safe health condition by presenting a valid vaccination certificate. Dogs and other animals are not allowed in areas where food is stored, prepared or served. Dogs are to be muzzled and leashed in all public areas. Animals are not allowed to be left in the room without the supervision of their owner Animals are not allowed to lie on the bed or other guest facilities, they must have their own bed. Baths, showers or sinks cannot be used for bathing or washing animals. Inventory that is used to feed the animals may not be used to feed the guests. The owner of the animal is responsible for observing the night-time curfew from 22:00 to 07:00.",
    rule15: "15. The guesthouse is responsible for items brought into the guesthouse by the guest, for damage to the items left behind, if these items have been stored in a place reserved for this purpose. The guest house is only liable for money and valuable items if it has taken them into custody against a receipt.",
  ...
  privacy: {
    ...
    whatDataIntro: "Through our non-binding reservation form, we collect the following personal data:",
    dataName: "First and last name",
    dataEmail: "Email address",
    dataPhone: "Phone number",
    whyDataTitle: "Why do we collect this data?",
    whyDataText: "We collect data exclusively for the purpose of processing your non-binding reservation and possible communication with you. The legal basis for the processing of personal data is Art. 6 para. 1 letter b) GDPR - fulfillment of a contract or pre-contractual measures.",
    howLongTitle: "How long do we store your data?",
    howLongText: "We store your data for the time necessary to process the reservation, but for a maximum of 6 months. After that, they will be safely deleted.",
    whoShareTitle: "Who do we share your data with?",
    whoShareText: "Your personal data is not provided to any third party.",
    securityTitle: "How do we protect your data?",
    securityText: "Personal data is stored in a secure system and is not accessible to unauthorized persons.",
    ...
    rightsContact: "Contact us at our email and we will process your request.",
    complaintTitle: "Possibility to file a complaint",
    complaintText: "If you believe that your personal data has been handled in violation of legal regulations, you have the right to file a complaint with the Office for Personal Data Protection (www.uoou.cz).",
    contactTitle: "Contact",
    contactText: "If you have any questions regarding the processing of your personal data, do not hesitate to contact us at our email harmonie-bedrichov@centrum.cz"
  }
},
de: {
  nav: {
  ...
  prices: {
    ...
    table: {
      ...
      single_room_winter: `${priceValues.single_room_winter} CZK pro Person/Nacht`,
      single_room_summer: `${priceValues.single_room_summer} CZK pro Person/Nacht`,
      single_room_special: `${priceValues.single_room_special} CZK pro Person/Nacht`,
      apartment_surcharge: "Apartment-Zuschlag",
      apartment_surcharge_price: `${priceValues.apartment_surcharge} CZK pro Person/Nacht`,
